...
void init()
{
	...
	window = SDL_CreateWindow("Tutorial 05", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL);
...
void createShaderProgram ()
{
    ...
    uScaleLocation = glGetUniformLocation(program, "scale");
