...
const char* WINDOW_NAME = "Tutorial 17";
...
"void main()"
"{"
"    gl_FragColor = texture2D(sampler, uvCoord) * vec4(ambientColor, 1.0) * ambientIntensity;"
"}";

static float directionLightIntensity = 0.5f;
...
void render ()
{
	...
	glUniform1f(uAmbientIntensity, directionLightIntensity);
	glUniform3f(uAmbientColor, 1.0f, 1.0f, 1.0f);
...
void createShaderProgram ()
{
	...
	assert(uAmbientColor != 0xFFFFFFFF);
